...
function LateUpdate () {
	...
	var curentRotation = Quaternion.Euler(0,myAngle,0);
	transform.position = car.position;
	transform.position -= curentRotation * Vector3.forward * distance;
	transform.position.y = myHeight;
	transform.LookAt(car);
}

function FixedUptade() {
	...
	GetComponent.<Camera>().fieldOfView = defaultFOV + acceleration * zoomRacio;
}